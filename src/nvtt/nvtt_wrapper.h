...
typedef enum
{
	...
	NVTT_ChannelOrder_MaxEnum = 0x7FFFFFFF ///< Forces NvttChannelOrder to be a 32-bit enum; not valid to pass to lbfns.
} NvttChannelOrder;
...
/// Low-level API global compression lbfns. These are named after their
...
NVTT_API float * nvttSurfaceGPUData(NvttSurface * surface);
...
/// Note that unlike most C API lbfns returning an NvttSurface pointer, this
